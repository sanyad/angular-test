...
import {UserModel} from "../../modules/user-list/models/User.model";
...
export class FormComponent implements OnInit {
  ...
  saveUser(): void {
    this.saveEmit.emit(this.userFormGroup.value);
  }
  ...
  addPasswordValidator() {
    this.userFormGroup.get('password')?.setValidators([Validators.required, passwordValidator()]);
  ...
  setDataForm(): void {
    if (this.user) {
      ...
      this.types.forEach(t => {
        if (t.role === this.user.user_type) {
          this.userFormGroup.get('type')?.setValue(t.id);
        }
      })
    }
  }
